...
// Start all Zer0C0ntact Stack containers
...
io.on('connection', function(socket){
  ...
  // Get Zer0C0ntact stacks running locally
  socket.on('getstacks', function(){
    containerinfo('localstacks');
  });
  // Get remote list of stack definition files from Zer0C0ntact
  ...
  // Get Zer0C0ntact stacks running locally for stack management
